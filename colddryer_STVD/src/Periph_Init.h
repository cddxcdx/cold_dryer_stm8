...
#define TIM3_PERIOD       1240

/*LEDDisplay*/
#define LED_Disp_Dig1_PORT GPIOC
#define LED_Disp_Dig1_PIN GPIO_PIN_1
#define LED_Disp_g_PORT GPIOC
#define LED_Disp_g_PIN GPIO_PIN_2
#define LED_Disp_f_PORT GPIOC
#define LED_Disp_f_PIN GPIO_PIN_3
#define LED_Disp_a_PORT GPIOC
#define LED_Disp_a_PIN GPIO_PIN_4
#define LED_Disp_b_PORT GPIOC
#define LED_Disp_b_PIN GPIO_PIN_5
#define LED_Disp_d_PORT GPIOC
#define LED_Disp_d_PIN GPIO_PIN_6
#define LED_Disp_dp_PORT GPIOC
#define LED_Disp_dp_PIN GPIO_PIN_7

#define LED_Disp_Dig2_PORT GPIOD
#define LED_Disp_Dig2_PIN GPIO_PIN_2
#define LED_Disp_c_PORT GPIOD
#define LED_Disp_c_PIN GPIO_PIN_0   
#define LED_Disp_e_PORT GPIOE
#define LED_Disp_e_PIN GPIO_PIN_0
/*LED*/
